...
public class PathUtil {
    ...
    public static final Pattern KOTLIN_STDLIB_JS_JAR_PATTERN = Pattern.compile("kotlin-stdlib-js(-\\d[\\d.]+(-.+)?)?\\.jar");
    public static final Pattern KOTLIN_JS_LIBRARY_JAR_PATTERN = Pattern.compile("kotlin-stdlib-js(-\\d[\\d.]+(-.+)?)?\\.jar");
