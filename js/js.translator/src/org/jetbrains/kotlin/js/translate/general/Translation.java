...
public final class Translation {
    ...
    private static AstGenerationResult doGenerateAst(
        ...
        return new AstGenerationResult(program, internalModuleName, fragments);
    }
    ...
    private static JsProgramFragment mayBeGenerateTests(
        ...
        StaticContext staticContext = StaticContext.generateStaticContext(trace, config, moduleDescriptor);
        TranslationContext context = TranslationContext.rootContext(staticContext);
