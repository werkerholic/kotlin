...
@InlineOnly inline operator fun CSSStyleDeclaration.get(index: Int): String? = asDynamic()[index]
...
@InlineOnly inline operator fun MediaList.get(index: Int): String? = asDynamic()[index]
...
@InlineOnly inline operator fun StyleSheetList.get(index: Int): StyleSheet? = asDynamic()[index]
...
@InlineOnly inline operator fun CSSRuleList.get(index: Int): CSSRule? = asDynamic()[index]
