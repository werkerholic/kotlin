...
@InlineOnly inline operator fun Document.get(name: String): dynamic = asDynamic()[name]
...
@InlineOnly inline operator fun Window.get(name: String): dynamic = asDynamic()[name]
...
//@InlineOnly inline operator fun HTMLAllCollection.get(index: Int): Element? = asDynamic()[index]
//@InlineOnly inline operator fun HTMLAllCollection.get(name: String): UnionElementOrHTMLCollection? = asDynamic()[name]
...
//@InlineOnly override inline operator fun HTMLFormControlsCollection.get(name: String): UnionElementOrRadioNodeList? = asDynamic()[name]
...
@InlineOnly inline operator fun HTMLOptionsCollection.set(index: Int, option: HTMLOptionElement?): Unit { asDynamic()[index] = option; }
...
@InlineOnly inline operator fun DOMStringMap.get(name: String): String? = asDynamic()[name]
@InlineOnly inline operator fun DOMStringMap.set(name: String, value: String): Unit { asDynamic()[name] = value; }
...
@InlineOnly inline operator fun AudioTrackList.get(index: Int): AudioTrack? = asDynamic()[index]
...
@InlineOnly inline operator fun VideoTrackList.get(index: Int): VideoTrack? = asDynamic()[index]
...
@InlineOnly inline operator fun TextTrackList.get(index: Int): TextTrack? = asDynamic()[index]
...
@InlineOnly inline operator fun TextTrackCueList.get(index: Int): TextTrackCue? = asDynamic()[index]
...
@InlineOnly inline operator fun HTMLFormElement.get(index: Int): Element? = asDynamic()[index]
@InlineOnly inline operator fun HTMLFormElement.get(name: String): UnionElementOrRadioNodeList? = asDynamic()[name]
...
@InlineOnly inline operator fun HTMLSelectElement.get(index: Int): Element? = asDynamic()[index]
@InlineOnly inline operator fun HTMLSelectElement.set(index: Int, option: HTMLOptionElement?): Unit { asDynamic()[index] = option; }
...
@InlineOnly inline operator fun DataTransferItemList.get(index: Int): DataTransferItem? = asDynamic()[index]
...
@InlineOnly inline operator fun PluginArray.get(index: Int): Plugin? = asDynamic()[index]
@InlineOnly inline operator fun PluginArray.get(name: String): Plugin? = asDynamic()[name]
...
@InlineOnly inline operator fun MimeTypeArray.get(index: Int): MimeType? = asDynamic()[index]
@InlineOnly inline operator fun MimeTypeArray.get(name: String): MimeType? = asDynamic()[name]
...
@InlineOnly inline operator fun Plugin.get(index: Int): MimeType? = asDynamic()[index]
@InlineOnly inline operator fun Plugin.get(name: String): MimeType? = asDynamic()[name]
...
@InlineOnly inline operator fun Storage.get(key: String): String? = asDynamic()[key]
@InlineOnly inline operator fun Storage.set(key: String, value: String): Unit { asDynamic()[key] = value; }
...
@InlineOnly inline operator fun NodeList.get(index: Int): Node? = asDynamic()[index]
...
@InlineOnly inline operator fun HTMLCollection.get(index: Int): Element? = asDynamic()[index]
@InlineOnly inline operator fun HTMLCollection.get(name: String): Element? = asDynamic()[name]
...
@InlineOnly inline operator fun NamedNodeMap.get(index: Int): Attr? = asDynamic()[index]
@InlineOnly inline operator fun NamedNodeMap.get(qualifiedName: String): Attr? = asDynamic()[qualifiedName]
...
@InlineOnly inline operator fun DOMTokenList.get(index: Int): String? = asDynamic()[index]
...
@InlineOnly inline operator fun DOMRectList.get(index: Int): DOMRect? = asDynamic()[index]
